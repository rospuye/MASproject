function displayPedidos(){
    ...
    for (i=0; i<localStorage.length; i++){
        ...
        if (item.includes('"tipo":"pedido","estado":"rejeitado"')){
            console.log("HERE");
            nenhumPedidoFlag = 1;
            ...
            for (j=0; j<localStorage.length; j++){
                ...
                if (item2.includes('"tipo":"conta"')){
                    ...
                    if (item2.substring(indexArray3[5]+2,indexArray4[5]-1)==clientID){
                        ...
                        // colocar o pedido rejeitado em display na página
                        ...
                        for (p=0; p<localStorage.length; p++){
                            ...
                            if (itemName3.includes('dataRejeicao - '+itemName)){
                                ...
                                b2.innerText = "Rejeição: ";
                                p3.appendChild(b2);
                                rowDiv2.appendChild(p3);

                                var p4 = document.createElement("p");   
                                p4.id = "dataRejeicao" + pedidosCounter;
                        ...
                        var p25 = document.createElement("p");
                        var b10 = document.createElement("b");
                        b10.innerText = "Justificação da Show It: ";
                        p25.appendChild(b10);
                        newDiv.appendChild(p25);

                        var p26 = document.createElement("p");
                        p26.id = "justificacao" + pedidosCounter;
