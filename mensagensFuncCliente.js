    ...
    if (value==true){
        ...
        for (i=0; i<localStorage.length; i++){
            ...
            if (item.includes('"tipo":"login"')){
                ...
                var funcID = item.substring(indexArray[5]+2,indexArray2[5]-1);
...
function displayMensagens(){
    ...
    for (a=0; a<localStorage.length; a++){
        ...
        if (object.includes('"tipo":"login"')){
            ...
            idF = object.substring(indexArray[5]+2,indexArray2[5]-1);
    ...
    for (a=0; a<localStorage.length; a++){
        var object = localStorage.getItem(localStorage.key(a));
        var objectName = localStorage.key(a);
        if (object.includes('"tipo":"conta"') && object.includes('"ID":"' + idC + '"')){
            var indexArray = [];
            var indexArray2 = [];
    ...
    titleSpan.innerText = "Conversa com " + nomeC;
        ...
        for (a=0; a<localStorage.length; a++){
            ...
            if (objectName == ('Mensagem/' + idC + "/" + idF + '/nº' + i)){
                ...
                if (object.includes('"sender":"' + idF + '"')){
                    ...
                    title.innerText = nomeF.toLowerCase() + " (eu)";
                ...
                // the sender is the client
                    ...
                    title.innerText = nomeC.toLowerCase() + " (cliente)";
                    newDiv.appendChild(title);
